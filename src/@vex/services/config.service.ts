  ...
  configs: Config[] = [
    {
      ...
      name: 'Apollo',
      imgSrc: '//vex.visurel.com/landing/assets/img/apollo.png',
      layout: 'horizontal',
      boxed: false,
      sidenav: {
        state: 'expanded'
    ...
    },
    {
      ...
      name: 'Hermes',
      imgSrc: '//vex.visurel.com/landing/assets/img/hermes.png',
      layout: 'vertical',
      boxed: true,
      sidenav: {
        state: 'expanded'
    ...
    },
    {
      id: ConfigName.ares,
      name: 'Ares',
      imgSrc: '//vex.visurel.com/landing/assets/img/ares.png',
      layout: 'horizontal',
      boxed: false,
      sidenav: {
        state: 'expanded'
    ...
    },
    {
      id: ConfigName.zeus,
      name: 'Zeus',
      imgSrc: '//vex.visurel.com/landing/assets/img/zeus.png',
      layout: 'horizontal',
      boxed: false,
      sidenav: {
        state: 'collapsed'
    ...
    },
    {
      ...
      name: 'Ikaros',
      imgSrc: '//vex.visurel.com/landing/assets/img/ikaros.png',
      layout: 'vertical',
      boxed: true,
      sidenav: {
        state: 'expanded'
